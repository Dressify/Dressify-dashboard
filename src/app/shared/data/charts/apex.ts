...
export let barChart: ChartOptions | any = {
  ...
  xaxis: {
    categories: ["UK", "US", "India", "Korea", "Italy", "France", "Japan", "USA", "China", "Germany"],
    show: false,
    labels: {
      show: false,
    },
...
export let smallColumnChart2: ChartOptions | any = {
  chart: {
    height: 70,
    width: 90,
    type: "bar",
...
export let smallColumnChart3: ChartOptions | any = {
  chart: {
    height: 70,
    width: 90,
    type: "bar",
...
export let donutChart: ChartOptions | any = {
  ...
  colors: ["#dc3545", "#f8d62b", primary_color, "#7dc006", "#a927f9"],
};
...
export let mixedChart: ChartOptions | any = {
  ...
  colors: [secondary_color, "#7dc006", primary_color],
};
...
export let radialBarChart: ChartOptions | any = {
  ...
  colors: [secondary_color, "#7dc006", "#f8d62b", primary_color],
};
